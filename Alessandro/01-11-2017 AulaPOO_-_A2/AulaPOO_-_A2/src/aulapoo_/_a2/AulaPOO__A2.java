...
public class AulaPOO__A2 {
    ...
    public static void CadastroAluno() {
        ...
        */
        ...
        // lista e dinamica, nao precisa mais de vetor
        
        /* nao e mais vetor, e uma lista (ArrayList)
        ...
        */
        ...
        nakamura.setBoletims(list); 
        // coloca o objeto, uma lista vazia na memoria
        String continuar = "s";
        ...
        while(continuar.equalsIgnoreCase("s")) {
            ...
            desempenho.setNota2(okazaki.nextFloat());
            desempenho.setDisciplina(materia);
            nakamura.getListaBoletims().add(desempenho); 
            // pega os dados informados e coloca na lista vazia
            // cmd add adciona dinamicamente dados na lista
            System.out.println("Deseja continuar? 's' ou 'n' ");
            continuar = okazaki.next();
        }
    ...
    public static void CadastroProfessor() {
        // 01-11-2017
        String n2 = "4";
        int num2 = Integer.parseInt(n2); // Typecast de int
        String f4 = "4.78";
        float num4 = Float.parseFloat(f4);
        
        ArrayList<Object> lista_prof = new ArrayList();
        Turma turma = new Turma();
        System.out.println(turma);
        turma.setNome_turma("A2");
        lista_prof.add(turma);
        turma = new Turma();
        System.out.println(turma);
        turma.setNome_turma("A3");
        lista_prof.add(turma);
        lista_prof.add(n2);
        lista_prof.add(true);
        lista_prof.add(1.78);
        
        for (int i = 0; i < lista_prof.size(); i++) {
            Turma tur = (Turma)lista_prof.get(i); // Typecast antigo de listas
        }
